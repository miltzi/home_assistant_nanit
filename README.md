...
`docker pull miltzi/home_assistant_nanit`
...
`docker run -it -v /path/to/data:/data --entrypoint=/app/scripts/init-nanit.sh miltzi/home_assistant_nanit`
