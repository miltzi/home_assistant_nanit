...
`docker pull joshmiltz/home_assistant_nanit`
...
`docker run -it -v /path/to/data:/data --entrypoint=/app/scripts/init-nanit.sh joshmiltz/home_assistant_nanit`
...
docker run \
  ...
  -p 1935:1935 \
  joshmiltz/home_assistant_nanit
```
